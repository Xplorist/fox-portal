...
import com.foxconn.mcebg.portal.oidc.model.PKCEAlgorithm;
...
import com.foxconn.mcebg.portal.oidc.service.JWTSigningAndValidationService;
import com.foxconn.mcebg.portal.oidc.service.impl.JWKSetCacheService;
import com.foxconn.mcebg.portal.oidc.service.impl.SymmetricKeyJWTValidatorCacheService;
...
import static com.foxconn.mcebg.portal.oidc.model.ClientDetailsEntity.AuthMethod.*;
...
public class OIDCAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private AuthRequestOptionsService authRequestOptionsService = new StaticAuthRequestOptionsService(); // initialize with an empty set of options
    ...
    protected void handleAuthorizationRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (issResp.shouldRedirect()) {
            ...
            Map<String, String> options = authRequestOptionsService.getOptions(serverConfig, clientConfig, request);
            ...
            String authRequest = authRequestUrlBuilder.buildAuthRequestUrl(serverConfig, clientConfig, redirectUri, nonce, state, options, issResp.getLoginHint());
    ...
    protected Authentication handleAuthorizationCodeResponse(HttpServletRequest request, HttpServletResponse response) throws ParseException {
    ...
    public void setServerConfigurationService(ServerConfigurationService servers) {
        this.serverConfigurationService = servers;
    }
    ...
    public void setClientConfigurationService(ClientConfigurationService clients) {
        this.clientConfigurationService = clients;
    }
    ...
    public void setAuthRequestUrlBuilder(AuthRequestUrlBuilder authRequestBuilder) {
        this.authRequestUrlBuilder = authRequestBuilder;
    }
    ...
    public void setAuthRequestOptionsService(AuthRequestOptionsService authOptions) {
        this.authRequestOptionsService = authOptions;
    }
